...
void	CResourceManager::LS_Load			()
{
	...
	[
		...
		class_<adopt_compiler>("_compiler")
			...
			.def("begin",						&adopt_compiler::_passgs		, policy::return_reference_to<1>())
			...
			.def("dx10color_write_enable",		&adopt_compiler::_dx10color_write_enable, policy::return_reference_to<1>())
			.def("color_write_enable",			&adopt_compiler::_dx10color_write_enable, policy::return_reference_to<1>())
			.def("dx10texture",					&adopt_compiler::_dx10texture	, policy::return_reference_to<1>())
			.def("dx10stencil",					&adopt_compiler::_dx10Stencil	, policy::return_reference_to<1>())
			.def("dx10stencil_ref",				&adopt_compiler::_dx10StencilRef, policy::return_reference_to<1>())
			.def("dx10atoc",					&adopt_compiler::_dx10ATOC		, policy::return_reference_to<1>())
			.def("dx10zfunc",					&adopt_compiler::_dx10ZFunc		, policy::return_reference_to<1>())

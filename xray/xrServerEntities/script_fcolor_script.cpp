...
void CScriptFcolor::script_register(lua_State *L)
{
	...
	[
		class_<Fcolor>("fcolor")
			...
			.def(								constructor<>())
			.def("set",							(Fcolor & (Fcolor::*)(float,float,float,float))(&Fcolor::set), policy::return_reference_to<1>())
			.def("set",							(Fcolor & (Fcolor::*)(const Fcolor &))(&Fcolor::set), policy::return_reference_to<1>())
			.def("set",							(Fcolor & (Fcolor::*)(u32))(&Fcolor::set), policy::return_reference_to<1>())
	];
}

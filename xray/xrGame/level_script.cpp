...
//-		def("map_add_object_spot_complex",		map_add_object_spot_complex),
	...
	class_< xrTime >("CTime")
		...
		.def("set"					,&xrTime::set)
		.def("get"					,&xrTime::get, policy_list<policy::pure_out_value<2>, policy::pure_out_value<3>, policy::pure_out_value<4>, policy::pure_out_value<5>, policy::pure_out_value<6>, policy::pure_out_value<7>, policy::pure_out_value<8>>())

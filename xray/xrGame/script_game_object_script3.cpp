...
class_<CScriptGameObject> &script_register_game_object2(class_<CScriptGameObject> &instance)
{
	instance
		...
		.def("memory_visible_objects",		&CScriptGameObject::memory_visible_objects, policy::return_stl_iterator())
		.def("memory_sound_objects",		&CScriptGameObject::memory_sound_objects, policy::return_stl_iterator())
		.def("memory_hit_objects",			&CScriptGameObject::memory_hit_objects, policy::return_stl_iterator())
		.def("not_yet_visible_objects",		&CScriptGameObject::not_yet_visible_objects, policy::return_stl_iterator())
...
//		.def("set_sight",					(void (CScriptGameObject::*)(const MemorySpace::CMemoryInfo *memory_object, bool	torso_look))(&CScriptGameObject::set_sight))
		...
		.def("accessible_nearest",			&CScriptGameObject::accessible_nearest, policy::pure_out_value<3>())
		...
		.def("give_task",					&CScriptGameObject::GiveTaskToActor,		policy::adopt<2>())
